...
void TextSearchIndexManager::load_text_search_index(
    const std::string& name,
    const TextSearchIndexMetadata& metadata
)
{
    try {
...
TextSearchIndex* TextSearchIndexManager::get_text_search_index(const std::string& name)
{
