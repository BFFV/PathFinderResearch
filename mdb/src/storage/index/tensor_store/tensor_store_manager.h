...
public:
    ...
    const boost::unordered_flat_map<std::string, TensorStoreMetadata>& get_name2metadata() const
    {
...
private:
    ...
    boost::unordered_flat_map<std::string, uint64_t> name2tensor_store_id;

    boost::unordered_flat_map<std::string, std::unique_ptr<TensorStore>> name2tensor_store;

    boost::unordered_flat_map<std::string, TensorStoreMetadata> name2metadata;
