...
int main(int argc, char* argv[])
{
    ...
    if (argc < 2) {
        FATAL_ERROR("usage: profile-query <database-folder> <query-file> [OPTIONS]");
    }
    ...
    auto config = parse_profile_config(args);
    config.db_directory = argv[1];
