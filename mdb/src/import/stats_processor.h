...
public:
    ...
    boost::unordered_flat_map<uint64_t, uint64_t> dict;
...
public:
    ...
    boost::unordered_flat_map<uint64_t, uint64_t> map_key_count;
    boost::unordered_flat_map<uint64_t, uint64_t> map_distinct_values;
...
public:
    ...
    boost::unordered_flat_map<uint64_t, uint64_t> map_label_count;
...
public:
    ...
    boost::unordered_flat_map<uint64_t, uint64_t> map_predicate_count;
