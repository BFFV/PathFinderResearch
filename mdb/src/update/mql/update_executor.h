...
private:
    ...
    boost::unordered_flat_map<std::string, TextSearchIndexUpdateData> name2text_search_index_update_data;

    boost::unordered_flat_map<std::string, TensorStoreUpdateData> name2tensor_store_update_data;
