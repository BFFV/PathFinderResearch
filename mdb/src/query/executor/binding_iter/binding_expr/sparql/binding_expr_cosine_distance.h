...
public:
    ...
    BindingExprCosineDistance(std::unique_ptr<BindingExpr> lhs, std::unique_ptr<BindingExpr> rhs) :
        lhs(std::move(lhs)),
        rhs(std::move(rhs))
    { }
    ...
    ObjectId eval(const Binding& binding) override
    {
        ...
        case Conversions::OPTYPE_TENSOR_FLOAT: {
            ...
            return Conversions::pack_float(lhs.cosine_distance(rhs));
        }
        case Conversions::OPTYPE_TENSOR_DOUBLE: {
            ...
            return Conversions::pack_double(lhs.cosine_distance(rhs));
        }
