...
#include "query/executor/binding_iter/hnsw_index_scan_fixed_query.h"  // IWYU pragma: keep
...
#include "query/executor/binding_iter/text_search_index_multi_scan.h" // IWYU pragma: keep
