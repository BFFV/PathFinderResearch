...
public:
    ...
    std::vector<std::unique_ptr<BindingIter>> build_hnsw_searches(const std::vector<OpHNSWSearchIndex>& hnsw_searches);

    std::vector<std::unique_ptr<BindingIter>> build_text_searches(const std::vector<OpTextSearchIndex>& text_searches);
