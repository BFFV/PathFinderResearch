...
void ExecutorConstructor::visit(OpShow& op_show)
{
    ...
    case MQL::ReturnType::CSV:
        if (op_show.type == OpShow::Type::TENSOR_STORE) {
            executor = std::make_unique<ShowExecutor<ReturnType::CSV, OpShow::Type::TENSOR_STORE>>();
            break;
        } else if (op_show.type == OpShow::Type::TEXT_SEARCH_INDEX) {
            executor = std::make_unique<ShowExecutor<ReturnType::CSV, OpShow::Type::TEXT_SEARCH_INDEX>>();
            break;
        }
        [[fallthrough]];
    ...
    case MQL::ReturnType::TSV:
        if (op_show.type == OpShow::Type::TENSOR_STORE) {
            executor = std::make_unique<ShowExecutor<ReturnType::TSV, OpShow::Type::TENSOR_STORE>>();
            break;
        } else if (op_show.type == OpShow::Type::TEXT_SEARCH_INDEX) {
            executor = std::make_unique<ShowExecutor<ReturnType::TSV, OpShow::Type::TEXT_SEARCH_INDEX>>();
            break;
        }
        [[fallthrough]];
