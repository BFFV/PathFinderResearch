...
void PushWhereExpr::visit(ExprAddition&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprDivision&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprModulo&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprMultiplication&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprSubtraction&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprUnaryMinus&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprUnaryPlus&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprGreaterOrEquals&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprGreater&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprIs&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprLessOrEquals&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprLess&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprNotEquals&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprNot&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprOr&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprRegex&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprTensorDistance&)
{
    can_remove = false;
}
void PushWhereExpr::visit(ExprTextSearch&)
{
    can_remove = false;
}
