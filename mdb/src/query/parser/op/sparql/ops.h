...
#include "query/parser/op/sparql/op_ask.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_basic_graph_pattern.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_bind.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_construct.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_describe.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_empty.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_filter.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_from.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_graph.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_group_by.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_having.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_join.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_minus.h" // IWYU pragma: export
#include "query/parser/op/sparql/op_not_exists.h" // IWYU pragma: export
