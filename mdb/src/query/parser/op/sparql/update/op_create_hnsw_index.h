...
public:
    ...
    OpCreateHnswIndex(
        ...
        hnsw_index_name { std::move(hnsw_index_name_) },
    ...
    {
        auto hnsw_index_name_clone = hnsw_index_name;
        auto predicate_clone = predicate;
        return std::make_unique<OpCreateHnswIndex>(
            std::move(hnsw_index_name_clone),
    ...
    std::ostream& print_to_ostream(std::ostream& os, int indent = 0) const override
    {
        ...
        os << "OpCreateHnswIndex(hnsw_index_name: " << hnsw_index_name;
