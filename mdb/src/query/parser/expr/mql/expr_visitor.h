...
public:
    ...
    virtual void visit(MQL::ExprTensorDistance&)
    {
        throw LogicException("visit MQL::ExprTensorDistance not implemented");
    }
    virtual void visit(MQL::ExprTextSearch&)
    {
        throw LogicException("visit MQL::ExprTextSearch not implemented");
    }
};
} // namespace MQL
