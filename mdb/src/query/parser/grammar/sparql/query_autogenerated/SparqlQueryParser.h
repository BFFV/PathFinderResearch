...
public:
  enum {
    ...
    ACYCLIC = 103, WALKS = 104, SHOW = 105, TEXT = 106, INDEX = 107, HNSW = 108, 
    IRIREF = 109, PNAME_NS = 110, PNAME_LN = 111, BLANK_NODE_LABEL = 112, 
    VAR1 = 113, VAR2 = 114, LANGTAG = 115, INTEGER = 116, DECIMAL = 117, 
    DOUBLE = 118, INTEGER_POSITIVE = 119, DECIMAL_POSITIVE = 120, DOUBLE_POSITIVE = 121, 
    INTEGER_NEGATIVE = 122, DECIMAL_NEGATIVE = 123, DOUBLE_NEGATIVE = 124, 
    STRING_LITERAL1 = 125, STRING_LITERAL2 = 126, STRING_LITERAL_LONG1 = 127, 
    STRING_LITERAL_LONG2 = 128, COMMENT = 129, REFERENCE = 130, LESS_EQUAL = 131, 
    GREATER_EQUAL = 132, NOT_EQUAL = 133, AND = 134, OR = 135, INVERSE = 136, 
    OPEN_BRACE = 137, CLOSE_BRACE = 138, OPEN_CURLY_BRACE = 139, CLOSE_CURLY_BRACE = 140, 
    OPEN_SQUARE_BRACKET = 141, CLOSE_SQUARE_BRACKET = 142, SEMICOLON = 143, 
    DOT = 144, PLUS_SIGN = 145, MINUS_SIGN = 146, ASTERISK = 147, QUESTION_MARK = 148, 
    COMMA = 149, NEGATION = 150, DIVIDE = 151, EQUAL = 152, LESS = 153, 
    GREATER = 154, PIPE = 155, ANY_OTHER = 156
  };
  ...
  public:
    ...
    antlr4::Token *s151 = nullptr;
    antlr4::Token *_tset1725 = nullptr;
  ...
  public:
    ...
    std::vector<antlr4::Token *> op;
    antlr4::Token *s151 = nullptr;
    antlr4::Token *_tset1768 = nullptr;
