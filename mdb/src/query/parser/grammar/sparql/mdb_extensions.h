 ...
 *
 * The main result will be projected into ?res, while additional projections may be possible through
 * the arguments
 *
 */
...
static std::string HNSW_SEARCH_SUFFIX_IRI = "hnswSearch";
static std::string HNSW_SEARCH_IRI = PROCEDURE_PREFIX_IRI + HNSW_SEARCH_SUFFIX_IRI;
} // namespace Procedure
