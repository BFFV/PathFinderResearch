 ...
 */
lexer grammar SparqlUpdateLexer;
...
NORMALIZE: ('N'|'n')('O'|'o')('R'|'r')('M'|'m')('A'|'a')('L'|'l')('I'|'i')('Z'|'z')('E'|'e');
ON: ('O'|'o')('N'|'n');
TEXT: ('T'|'t')('E'|'e')('X'|'x')('T'|'t');
TOKENIZE: ('T'|'t')('O'|'o')('K'|'k')('E'|'e')('N'|'n')('I'|'i')('Z'|'z')('E'|'e');
WHITESPACE: ('W'|'w')('H'|'h')('I'|'i')('T'|'t')('E'|'e')('S'|'s')('P'|'p')('A'|'a')('C'|'c')('E'|'e');
WS_KEEP_PUNCT: ('W'|'w')('S'|'s')('_')('K'|'k')('E'|'e')('E'|'e')('P'|'p')('_')('P'|'p')('U'|'u')('N'|'n')('C'|'c')('T'|'t');
WS_RM_PUNCT: ('W'|'w')('S'|'s')('_')('R'|'r')('M'|'m')('_')('P'|'p')('U'|'u')('N'|'n')('C'|'c')('T'|'t');
WS_SPLIT_PUNCT: ('W'|'w')('S'|'s')('_')('S'|'s')('P'|'p')('L'|'l')('I'|'i')('T'|'t')('_')('P'|'p')('U'|'u')('N'|'n')('C'|'c')('T'|'t');
WS_SYMBOLS: ('W'|'w')('S'|'s')('_')('S'|'s')('Y'|'y')('M'|'m')('B'|'b')('O'|'o')('L'|'l')('S'|'s');

HNSW: ('H'|'h')('N'|'n')('S'|'s')('W'|'w');
CANDIDATES: ('C'|'c')('A'|'a')('N'|'n')('D'|'d')('I'|'i')('D'|'d')('A'|'a')('T'|'t')('E'|'e')('S'|'s');
DIMENSION: ('D'|'d')('I'|'i')('M'|'m')('E'|'e')('N'|'n')('S'|'s')('I'|'i')('O'|'o')('N'|'n');
MAX_EDGES: ('M'|'m')('A'|'a')('X'|'x')('_')('E'|'e')('D'|'d')('G'|'g')('E'|'e')('S'|'s');
