...
- Object File Size: 2<sup>48</sup> bytes (limited by extendible_hash) TODO: may be less and collisions may be greater
- Max hash (murmur3) collisions: TODO:
    - TODO: collisions for tuples (hash distinct)?
...
- **Connections** The auto-generated identifier will match the regular expression `_c[1-9][0-9]*`.